        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Client Logo') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Client') }}</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{ __('Client') }} @lang('List')</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search client')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <!--begin::Add product-->
                            <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">@lang('Add') {{ __('Client Logo')}}</a>
                            <!--end::Add product-->
                        </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kk_modal_form" class="form">
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">@lang('Client Logo')</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="client_name" id="name" placeholder="@lang('Enter Client Name')"></textarea>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Logo')</span>
                            </label>
                            <!--end::Label-->
        ...
        function edit(id){
            $.ajax({
                ...
                success:function(data){
                   ...
                   $('.image-input').css('background-image','url('+data.logo+')');
                   $('.image-input-wrapper').css('background-image','url('+data.logo+')')
                   $("#kk_modal").modal('show');
                }
          });
        }
    ...
    function deleteClient(id){
        Swal.fire({
            ...
            if(o.value){ //if agree
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/clients/delete') }}"+'/'+id,
                    data: {},
