            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Services') }}</li>
                        <!--end::Item-->
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search services')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kk_modal_form" class="form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <textarea class="form-control form-control-solid" rows="5" name="description" id="description" placeholder="@lang('Enter Description')"></textarea>
...
<script>
    ...
    // add new
    function addNew(){
        $('#kk_modal_title').text("{{__('Add Service')}}")
