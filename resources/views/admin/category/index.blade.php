        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Category') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Category') }}</li>
                        <!--end::Item-->
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <!--begin::Add product-->
                            <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">@lang('Add') {{ __('Add New')}}</a>
                            <!--end::Add product-->
                        </div>
...
<script>
    ...
    // add new
    function addNew(){
        $('#kk_modal_title').text('Add Category')
    ...
    function edit(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('.image-input').css('background-image','url('+data.icon+')')
                $('.image-input-wrapper').css('background-image','url('+data.icon+')')
                $("#kk_modal").modal('show');
            }
        });
    }
