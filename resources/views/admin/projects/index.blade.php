        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Project') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Project') }}</li>
                        <!--end::Item-->
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search project')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kk_modal_form" class="form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Service')</span>
                            </label>
                            <!--end::Label-->
                            <select class="form-control form-control-solid" name="service" id="service">
                            ...
                            <div class="help-block with-errors service-error"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Project Name')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="project_name" id="project_name" placeholder="@lang('Enter Project Name')" />
                            <div class="help-block with-errors project_name-error"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <textarea class="form-control form-control-solid" name="description" id="description" placeholder="@lang('Enter Description')" ></textarea>
...
<script>
    ...
    @forelse ($services as $serv)
        services += '<option value="{{$serv->id}}">{{$serv->title}}</option>';
    @empty
    ...
    // add new
    function addNew(){
        $('#kk_modal_title').text('{{__("Add Project")}}')
