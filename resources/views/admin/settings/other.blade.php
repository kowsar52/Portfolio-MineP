        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">@lang('Other Settings')</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bolder">@lang('Other Settings')</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                        ...
                        @foreach ($settings as $setting)
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                    <input type="date" class="form-control form-control-solid" name="setting[{{$setting->name}}]" value="{{$setting->value}}">
