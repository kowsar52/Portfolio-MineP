        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Member') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Member') }}</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">{{ __('Member') }} @lang('List')</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Button-->
                    <a href="{{ route('admin.clients') }}" class="btn btn-sm btn-primary">@lang('Back')</a>
                    <!--end::Button-->
                </div>
                <!--end::Actions-->
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search member')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            <!--begin::Add product-->
                            <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">@lang('Add') {{ __('Member')}}</a>
                            <!--end::Add product-->
                        </div>
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kk_modal_form" class="form">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="name" id="name" placeholder="@lang('Enter client name')">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Image')</span>
                            </label>
                            <!--end::Label-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Facebook Link')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="facebook" id="facebook" placeholder="@lang('Enter Facebook link')">
                            <div class="help-block with-errors facebook-error"></div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Instagram')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="instagram" id="instagram" placeholder="@lang('Enter Instagram link')">
                            <div class="help-block with-errors instagram-error"></div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Twitter')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="twitter" id="twitter" placeholder="@lang('Enter Twitter link')">
                            <div class="help-block with-errors twitter-error"></div>
                        </div>
                        <!--end::Input group-->
    ...
    function deleteMember(id){
        Swal.fire({
            ...
            if(o.value){ //if agree
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/members/delete') }}"+'/'+id,
                    data: {},
