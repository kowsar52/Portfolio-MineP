        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Testimonial') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ __('Testimonial') }}</li>
                        <!--end::Item-->
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search testimonial')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kk_modal_form" class="form" enctype="multipart/form-data">
                        ...
                        <!--begin:: Language Select group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Language')</span>
                            </label>
                            <!--end::Label-->
                            <select class="form-control form-control-solid" name="language" id="language">
                                <option value="en" {{ \App::getLocale() == 'en' ? 'selected' : ''}}>@lang('English')</option>
                                <option value="de" {{ \App::getLocale() == 'de' ? 'selected' : ''}}>@lang('Germany')</option>
                            </select>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Client Name')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="client_name" id="client_name" placeholder="@lang('Enter Client Name')" />
                            <div class="help-block with-errors client_name-error"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Designation')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="designation" id="designation" placeholder="@lang('Enter Designation')" />
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Feedback')</span>
                            </label>
                            <!--end::Label-->
                            <textarea class="form-control form-control-solid" name="feedback" id="feedback" placeholder="@lang('Enter Feedback')" ></textarea>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Star')</span>
                            </label>
                            <!--end::Label-->
                            <input type="number" min="1" max="5" class="form-control form-control-solid" name="star" id="star" placeholder="@lang('Enter Star')" />
                            <div class="help-block with-errors star-error"></div>
                        </div>
                        <!--end::Input group-->
                        <!--begin:: Title Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span >@lang('Preview Link')</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" name="preview_link" id="preview_link" placeholder="@lang('Enter Preview Link')" />
                            <div class="help-block with-errors preview_link-error"></div>
                        </div>
                        <!--end::Input group-->
...
@push('script')
<script>
    let language = `<option value="en" {{ \App::getLocale() == 'en' ? 'selected' : ''}}>@lang('English')</option>
                    <option value="de" {{ \App::getLocale() == 'de' ? 'selected' : ''}}>@lang('Germany')</option>`;
    let status   = `<option value="1">@lang('Active')</option>
            ...
            columns: [
                ...
                {   data : "status" ,
                    render : function ( data) {
                        if(data == 1)
                        {
                            return `<span class="badge badge-light-success fw-bolder">@lang('Active')</span>`;
                        }else{
                            return `<span class="badge badge-light-danger fw-bolder">@lang('Deactive')</span>`;
                        }
                    },
                    orderable: false,
                    searchable: false
    ...
    // add new
    function addNew(){
        $('#kk_modal_title').text('{{__("Add Testimonial")}}')
    ...
    function edit(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("textarea#feedback").val(data.feedback);
                $('input[name="preview_link"]').val(data.preview_link)
