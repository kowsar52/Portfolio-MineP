...
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">@lang('FAQ')</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">FAQ @lang('Management')</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">FAQ @lang('List')</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kk-product-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="@lang('Search faq')">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5"
                            ...
                            {{-- <div class="w-100 mw-150px" data-select2-id="select2-data-122-mhmq">
                                ...
                                <select class="form-select form-select-solid select2-hidden-accessible kk-datatable-filter"
                                    data-control="select2" data-hide-search="true" data-placeholder="@lang('Status')"
                            ...
                            <!--begin::Add product-->
                            <a href="javascript:;" class="btn btn-sm btn-primary me-3" onclick="addNew()">@lang('Add') FAQ</a>
                            <!--end::Add product-->
                        </div>
    ...
    <div class="modal fade" id="kk_modal_new_service_types" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kk_modal_new_service_types_form" class="form">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Question')</span>
                            </label>
                            <!--end::Label-->
                            <textarea class="form-control form-control-solid" name="question" id="question" placeholder="@lang('Enter Question')"></textarea>
                            {{-- <input type="text" class="form-control form-control-solid" placeholder="Enter Service Type Name"
                                name="name" id="name"/> --}}
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                <span class="required">@lang('Answer')</span>
                            </label>
                            <!--end::Label-->
                            <textarea class="form-control form-control-solid" name="answer" rows="5" id="answer" placeholder="@lang('Enter answer')"></textarea>
                            {{-- <input type="text" class="form-control form-control-solid" placeholder="Enter Service Type Name"
                                name="name" id="name"/> --}}
                        ...
                        <div class="text-center">
                            <button type="reset" id="kk_modal_new_service_cancel" data-bs-dismiss="modal" class="btn btn-light me-3">@lang('Cancel')</button>
...
@push('script')
    <script type="text/javascript">
        ...
        function addNew(){
            ...
            $('#kk_modal_new_service_types_form')[0].reset();
            $('#kk_modal_new_service_types').modal('show')
        }
        //edit modal
        function edit(id){
            $.ajax({
                type:"GET",
                url: "{{ url('admin/faqs/get-faq')}}"+'/'+id,
                dataType: 'json',
                success:function(data){
                   $('input[name="faq_id"]').val(data.id)
        ...
        //new service type save
        $('#kk_modal_new_service_types_form').on('submit',function(e){
            e.preventDefault()
            $('.with-errors').text('')
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success ==  false || data.success ==  "false"){
                        ...
                        $('#kk_modal_new_service_types_form').find('.messages').html(alertBox).show();
                    }else{
                        // empty the form
                        $('#kk_modal_new_service_types_form')[0].reset();
                        $("#kk_modal_new_service_types").modal('hide');
