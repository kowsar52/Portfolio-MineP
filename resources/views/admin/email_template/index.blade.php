        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">@lang('All Email Template') </h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">@lang('Email Template List')</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="{{ __('Search user') }}">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var table = $('#dataTable').DataTable({
            ...
            responsive: true,
            serverSide: true,
            ajax: "{{ url('admin/email-templates') }}",
            columns: [
