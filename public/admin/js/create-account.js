            ...
            (e = document.querySelector("#kt_modal_create_account")) && new bootstrap.Modal(e), t = document.querySelector("#kt_create_account_stepper"), i = t.querySelector("#kt_create_account_form"), o = t.querySelector('[data-kt-stepper-action="submit"]'), s = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on("kt.stepper.changed", (function (e) {
                ...
                t ? t.validate().then((function (t) {
                    console.log("validated!"), "Valid" == t ? (e.goNext(), KTUtil.scrollTop()) : Swal.fire({
                        text: "Tut mir leid, anscheinend wurden einige Fehler erkannt. Bitte versuchen Sie es erneut.",
                        icon: "error",
                        buttonsStyling: !1,
                        confirmButtonText: "OK habe es!",
                        customClass: {
                ...
                fields: {
                    account_type: {
                        validators: {
                            notEmpty: {
                                message: "Kontotyp ist erforderlich"
                            }
                        }
                    }
                },
                ...
                fields: {
                    ...
                    shop_name: {
                        validators: {
                            notEmpty: {
                                message: "Shop-Name ist erforderlich"
                            }
                        }
                    },
                    mobile: {
                ...
                fields: {
                    company_register: {
                        validators: {
                            notEmpty: {
                                message: "Unternehmensregister ist erforderlich"
                            }
                        }
                    },
                    company_register_no: {
                        validators: {
                            notEmpty: {
                                message: "Unternehmenregister-Nr ist erforderlich"
                            }
                        }
                    },
                    legal_representative: {
                        validators: {
                            notEmpty: {
                                message: "Gesetzlicher Vertreter ist erforderlich"
                            }
                        }
                    },
                    vat_no: {
